            ...
            if (callbacks.dragHandlers) {
                ...
                setListener(billboard, 'leftDown', function (position) {
                    ...
                    handler.setInputAction(function (movement) {
                        ...
                        var   position1 = _self._scene.globe.pick(ray,scene);
                        var  cartographic= ellipsoid.cartesianToCartographic(position1);
                           //海拔
                           var height = _self._scene.globe.getHeight(cartographic);
                           //地理坐标（弧度）转经纬度坐标
    ...
    _.prototype.startDrawingMarker = function (options) {
        ...
        mouseHandler.setInputAction(function (movement) {
            if (movement.position != null) {
                ...
                var   position1 = scene.globe.pick(ray,scene);
                var  cartographic= ellipsoid.cartesianToCartographic(position1);
                   //海拔
    ...
    _.prototype.enhancePrimitives = function () {
        ...
        Cesium.Billboard.prototype.setEditable = function () {
            ...
            setListener(billboard, 'leftDown', function (position) {
                ...
                var   position1 = drawHelper._scene.globe.pick(ray,scene);
                var  cartographic= ellipsoid.cartesianToCartographic(position1);
                   //海拔
                   var height = drawHelper._scene.globe.getHeight(cartographic);
                   //地理坐标（弧度）转经纬度坐标
                   var point = Cesium.Cartesian3.fromDegrees(cartographic.longitude / Math.PI * 180, cartographic.latitude / Math.PI * 180, height);
                   var cartesian = point;
